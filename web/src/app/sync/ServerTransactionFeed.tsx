                  ...
                  transactions.map((transaction: TransactionServer) => (
                      <div key={transaction.id} className="transaction-item">
                        <div className="transaction-header">
                          <span
                              className="transaction-entity">{transaction.entity}</span>
                          <span
                              className="transaction-action">{transaction.action}</span>
                          <span
                              className="transaction-date">{formatDate(transaction.server_created_at)}</span>
                        </div>
                        <div className="transaction-content">
                          <div className="transaction-details">
                            <div><strong>ID:</strong> {transaction.id}</div>
                            <div>
                              <strong>Created:</strong> {formatDate(transaction.created_at)}
                            </div>
                          </div>
