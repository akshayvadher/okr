                    ...
                    icon: (
                        <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                            ...
                            <g className="animate-pulse-slow">
                                <circle cx="12" cy="12" r="8" strokeWidth="2" className="opacity-20" />
                            </g>
                            {/* Cheerful eyes */}
                            <g>
                    ...
                    icon: (
                        <svg className="w-6 h-6" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                            ...
                            <g className="animate-ripple">
                                <circle cx="12" cy="12" r="8" strokeWidth="2" className="opacity-20" />
                                <circle cx="12" cy="12" r="6" strokeWidth="2" className="opacity-40" />
                            </g>
                            {/* Big, sad eyes */}
    ...
    return (
        <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
                <div className={cn("relative flex items-center justify-center", statusConfig.color)}>
                    {statusConfig.icon}
                </div>
                <span className={cn("text-sm font-medium", statusConfig.color)}>{statusConfig.text}</span>
            </div>
            ...
            {status === 'not-connected' && pendingTransactions > 0 && (
                <div className="flex items-center gap-2 px-2 py-1 bg-red-50 rounded-full">
                    ...
                    >
                        ...
                        <rect x="6" y="8" width="12" height="8" rx="1" fill="currentColor" className="opacity-90" />
                        {/* Question mark */}
                        <path
