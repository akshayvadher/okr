        ...
        <div className="relative flex flex-col items-center">
          ...
          <div className="relative w-32 h-32">
            ...
            <div className="absolute inset-0">
              <div
                className="absolute top-0 left-0 w-2 h-2 bg-gray-900 rounded-full animate-sparkle"
                style={{ animationDelay: '0s' }}
              ></div>
              <div
                className="absolute top-0 right-0 w-2 h-2 bg-gray-900 rounded-full animate-sparkle"
                style={{ animationDelay: '0.5s' }}
              ></div>
              <div
                className="absolute bottom-0 left-0 w-2 h-2 bg-gray-900 rounded-full animate-sparkle"
                style={{ animationDelay: '1s' }}
              ></div>
              <div
                className="absolute bottom-0 right-0 w-2 h-2 bg-gray-900 rounded-full animate-sparkle"
