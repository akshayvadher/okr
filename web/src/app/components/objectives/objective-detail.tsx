...
// import { formatDate, getPercentageComplete } from "@/lib/utils";
...
export function ObjectiveDetail({ objectiveId }: ObjectiveDetailProps) {
  ...
  // const timePercentage = getPercentageComplete(objective.start_date, objective.end_date);

  return (
      <div>
        <div className="mb-8">
          <Link href="/objectives" className="inline-flex items-center text-sm text-gray-500 hover:text-gray-700 mb-4">
            ...
            <div>
              ...
              <div className="flex items-center gap-4 mt-2 text-sm text-gray-500">
                ...
                <div className="flex items-center">
                  ...
                  {/*<span>{timePercentage}% time elapsed</span>*/}
                </div>
              </div>
            </div>
          ...
          <div className="mt-6">
            <div className="flex justify-between items-center mb-2">
              <span className="font-medium">Overall Progress: {objective.progress}%</span>
            </div>
          ...
          {objective.key_results && objective.key_results.length > 0 ? (
              <div className="grid gap-4">
                {objective.key_results.map((keyResult) => (
                    <div key={keyResult.id} className="border rounded-lg p-4 bg-white">
